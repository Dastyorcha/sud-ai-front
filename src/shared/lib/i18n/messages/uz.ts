...
export const uz = {
  ...
  enums: {
    ...
    eventType: {
      HEARING_OPENED: "Majlis ochildi",
      IDENTITY_VERIFIED: "Shaxs tasdiqlandi",
      RIGHTS_EXPLAINED: "Huquqlar tushuntirildi",
      CLAIM_EXPLAINED: "Da'vo tushuntirildi",
      RESPONSE_GIVEN: "Javob berildi",
      OBJECTION_RAISED: "E'tiroz bildirildi",
      MOTION_SUBMITTED: "Ariza berildi",
      MOTION_DISCUSSION: "Ariza muhokamasi",
      EVIDENCE_SUBMITTED: "Dalil taqdim etildi",
      EVIDENCE_EXAMINED: "Dalil tekshirildi",
      QUESTION_ASKED: "Savol berildi",
      ANSWER_GIVEN: "Javob berildi",
      BREAK_ANNOUNCED: "Tanaffus e'lon qilindi",
      HEARING_POSTPONED: "Majlis kechiktirildi",
      RULING_ANNOUNCED: "Qaror e'lon qilindi",
      HEARING_CLOSED: "Majlis yopildi",
      OTHER: "Boshqa",
